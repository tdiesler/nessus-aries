...
public abstract class AbstractCamelAriesTest extends CamelTestSupport {
    ...
    public void setRemoveWalletsOnShutdown(boolean flag) {
        getHyperledgerAriesComponent().setRemoveWalletsOnShutdown(flag);
    }
    ...
    public NessusWallet onboardWallet(String walletName, IndyLedgerRoles role) throws IOException {
        ...
        WalletRegistry walletRegistry = getHyperledgerAriesComponent().getWalletRegistry();
    ...
    public AriesClient createClient(WalletRecord walletRecord) throws IOException {
        return getHyperledgerAriesComponent().createClient(walletRecord);
    }
